...
class XUpload extends XTemplate
{
    ...
    function __construct($title, $val, $name, $note, $action, $option = [])
    {
        parent::__construct();
        $this->params = [
            'title' => $title,
    ...
    function contentS()
    {
        ...
        if ($this->isElement) {
            $this->contentS = $this->fetch('element/form_upload.php', $this->params);
        } else {
            $this->contentS = $this->fetch('include/form_upload.php', $this->params);
        }
