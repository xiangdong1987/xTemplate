...
class XTimeSelect extends XTemplate
{
    ...
    function __construct($title, $name,$value, $start, $step, $end, $note, $relation = "", $option = [])
    {
        parent::__construct();
        $this->params = [
            'title' => $title,
    ...
    function contentS()
    {
        ...
        if ($this->isElement) {
            $this->contentS = $this->fetch('element/form_time_select.php', $this->params);
        } else {
            $this->contentS = $this->fetch('include/form_time_select.php', $this->params);
        }
