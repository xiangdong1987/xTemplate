                ...
                <div class="widget-body no-padding">
                    ...
                    <?php endif ?>
                        <div id="dt_basic_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <table class="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
                                    ...
                                    <tr>
                                        <?php foreach ($field as $v): ?>
                                            ...
                                            } ?>><label  <?php if ($v[\App\Grid::F_type] == 'checkbox'): ?>class="checkbox"<?php endif;?>>
                                                    <?php if ($v[\App\Grid::F_type] == 'checkbox'): ?>
                                                        <input type="checkbox" class="total-<?=$v[\App\Grid::F_name];?>"><i></i>
                            ...
                            <?php if ($pager) {
                                $this->display('include/page_ajax.php', $pager);
                            } ?>
                        </div>
                <!-- end widget content -->
